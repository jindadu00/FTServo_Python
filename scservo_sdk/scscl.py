...
class scscl(protocol_packet_handler):
    def __init__(self, portHandler):
        protocol_packet_handler.__init__(self, portHandler, SCS_END)
    ...
    def WritePos(self, scs_id, position, time, speed):
        ...
        # txpacket = [self.scs_hibyte(position), self.scs_lobyte(position), self.scs_hibyte(time), self.scs_lobyte(time), self.scs_hibyte(speed), self.scs_lobyte(speed)]
